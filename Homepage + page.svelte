	...
	<div class="container mx-auto px-4">
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
			...
			<div class="bg-white bg-opacity-10 p-6 rounded-lg">
				...
				<p class="mb-4">"I've tried many running shoes, but Sky Walkers are on another level. Perfect support for my marathon training, and they still look stylish enough for casual wear."</p>
			...
			<div class="bg-white bg-opacity-10 p-6 rounded-lg">
				...
				<p class="mb-4">"My kids love their Sky Walkers! Durable, comfortable, and they actually want to wear them. The customer service was excellent too when we needed to exchange sizes."</p>
				<div class="font-bold">Jennifer L.</div>
			</div>
		</div>
	</div>
</section>
...
<section class="py-12 bg-gray-100">
	<div class="container mx-auto px-4">
		<div class="max-w-xl mx-auto text-center">
			...
			<p class="text-gray-600 mb-6">Subscribe to get special offers, free giveaways, and once-in-a-lifetime deals.</p>
			...
			{:else}
				<form on:submit|preventDefault={subscribeToNewsletter} class="flex flex-col sm:flex-row gap-2">
					<input
						type="email"
						placeholder="Your email address"
						required
						bind:value={email}
						class="flex-grow px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
					/>
					<button
						type="submit"
